...
export class ResumeLangModel {
    ...
    constructor(resumeLang: number, personalInfo: PersonalInfoModel, personalExtraInfo: PersonalExtraInfoModel,
        edutationalBackGround: EducationalBackgroundModel[], courses: CourseModel[],
        professionalExperience: ProfessionalExperienceModel[], otherInformation: OtherInfoModel) {
