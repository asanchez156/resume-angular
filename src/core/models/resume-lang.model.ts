...
export class ResumeLangModel {
  ...
  private _otherInformation: OtherInfoModel;
	...
	constructor(resumeLang: number, personalExtraInfo: PersonalExtraInfoModel, edutationalBackGround: EducationalBackgroundModel[], courses: CourseModel[], professionalExperience: ProfessionalExperienceModel[], otherInformation: OtherInfoModel) {
